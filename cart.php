...
<head>
    ...
    <title>New Tech ||Cart Page</title>
        ...
        <div class="row">
                ...
                <div class="title">
                    <div class="row">
                        ...
                        if (isset($_SESSION["u"])) {
                            ...
                            cart.qty,cart.id,product_details.price,product_details.Shipping_colombo,product_details.Shipping_outside_colombo, 
                            (SELECT Product_Image_Path FROM product_pics WHERE product_pics.Product_ID = product_details.Product_ID LIMIT 1) AS Product_Image_Path
                            FROM  `cart`
            ...
            <div class="col-md-4 summary">
                ...
                <form id="checkout-form" method="POST">
                    <p>SHIPPING</p>
                    <select class="selectdelivery" name="shipping_option" required>
